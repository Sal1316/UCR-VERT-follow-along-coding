...
saveButton.addEventListener("click", function (event) {
  ...
  var studentGradeObj = {
    // we are getting the values from the user on the page.
  ...
  console.log("JSON.stringify ", JSON.stringify(studentGradeObj)); // returns an object that is a string.

  renderMessage();
});

function renderMessage() {
  var lastGrade = JSON.parse(localStorage.getItem("studentGradeObj")); //return and obj with correctly formated key/value pairs bc of JSON.parse
