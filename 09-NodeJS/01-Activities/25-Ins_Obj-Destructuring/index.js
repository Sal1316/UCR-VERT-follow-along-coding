...
const { name, parents } = jaime; // inside curly braces we say which objects we want to pull of 
...
const [winterfell, casterlyRock, kingLanding] = locations;  // naming array locations 
