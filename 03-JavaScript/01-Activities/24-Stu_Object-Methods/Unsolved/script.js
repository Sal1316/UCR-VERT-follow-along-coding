...
function dogMessage() {
   ...
   shelter.apptMessage();   
   // when the key property has a function as the value, you have to call use it with paranthesis.
}
...
console.log('Object values: ' + Object.values(shelter), 'Object keys: ' + Object.keys(shelter))