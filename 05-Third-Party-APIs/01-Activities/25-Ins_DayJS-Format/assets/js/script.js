...
// 3. Parse the following date, 11/3/2020. Convert to the following format: Sunday, February 14 2010, 3:25:50 pm.
var reformatDate = dayjs('2020-11-03').format('dddd, MMMM D YYYY, h:mm:ss a'); // HOW DOES IT KOW WHAT TIME IT IS?
$('#3a').text(reformatDate);

/* 4. I need to place my recycling bin on the curb on every odd week of the year for collection.
Do I need to put out my recycling bin out this week?
Dayjs' .diff() method does NOT include partial weeks in its calculation.*/
var beginningOfYear = dayjs('2022-01-01');
console.log("begining : " + beginningOfYear);
